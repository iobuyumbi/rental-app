...
// Calculate share per worker - Each worker gets full daily rate, not divided
workerTaskSchema.virtual("sharePerWorker").get(function () {
  // Each present worker gets the full task amount (their daily rate)
  // This ensures workers are paid their full daily rate per order per day
