...
// axios instance moved to ../api/http for reuse
...
export const inventoryAPI = {
  ...
  categories: {
    get: () =>
      api.get("/inventory/categories").then(handleResponse).catch(handleError),
    create: (categoryData) =>
      api
        .post("/inventory/categories", categoryData)
        .then(handleResponse)
        .catch(handleError),
    update: (id, categoryData) =>
      api
        .put(`/inventory/categories/${id}`, categoryData)
        .then(handleResponse)
        .catch(handleError),
    delete: (id) =>
      api
  ...
  products: {
    get: () =>
      api.get("/inventory/products").then(handleResponse).catch(handleError),
    getById: (id) =>
      api
    ...
    create: (productData) =>
      api
        .post("/inventory/products", productData)
        .then(handleResponse)
        .catch(handleError),
    update: (id, productData) =>
      api
        .put(`/inventory/products/${id}`, productData)
        .then(handleResponse)
        .catch(handleError),
    delete: (id) =>
      api
  ...
  getAvailableProducts: () =>
    api
      .get("/inventory/products/available", {
        headers: { "x-cache-max-age": "300000" }, // 5 minutes
      })
      .then(handleResponse)
      .catch(handleError),
...
export const ordersAPI = {
  ...
  getClient: (id) =>
    api.get(`/clients/${id}`).then(handleResponse).catch(handleError),
  addClient: (clientData) =>
    api.post("/clients", clientData).then(handleResponse).catch(handleError),
  updateClient: (id, clientData) =>
    api
      ...
      .catch(handleError),
  deleteClient: (id) =>
    api.delete(`/clients/${id}`).then(handleResponse).catch(handleError),
  getOrders: (params) =>
    api.get("/orders", { params }).then(handleResponse).catch(handleError),
  getOrder: (id) =>
    api.get(`/orders/${id}`).then(handleResponse).catch(handleError),
  ...
  markReturned: (id) =>
    api.put(`/orders/${id}/return`).then(handleResponse).catch(handleError),
  requestDiscount: (id, discountData) =>
    api
      .post(`/orders/${id}/discount/request`, discountData)
      .then(handleResponse)
      .catch(handleError),
  approveDiscount: (id, approvalData) =>
    api
      .put(`/orders/${id}/discount/approve`, approvalData)
      .then(handleResponse)
      .catch(handleError),
  updatePayment: (id, paymentData) =>
    api
      .put(`/orders/${id}/payment`, paymentData)
      .then(handleResponse)
      .catch(handleError),
  getViolations: (params) =>
    api
      .get("/orders/violations", { params })
      .then(handleResponse)
      .catch(handleError),
  getViolation: (id) =>
    api.get(`/orders/violations/${id}`).then(handleResponse).catch(handleError),
  createViolation: (violationData) =>
    api
      .post("/orders/violations", violationData)
      .then(handleResponse)
      .catch(handleError),
  updateViolation: (id, violationData) =>
    api
      .put(`/orders/violations/${id}`, violationData)
      .then(handleResponse)
      .catch(handleError),
  resolveViolation: (id, resolutionData) =>
    api
      .put(`/orders/violations/${id}/resolve`, resolutionData)
      .then(handleResponse)
      .catch(handleError),
  bulkResolveViolations: (violationIds, resolutionData) =>
    api
      .put("/orders/violations/bulk-resolve", {
        violationIds,
        ...resolutionData,
      })
      .then(handleResponse)
  ...
  deleteViolation: (id) =>
    api
      .delete(`/orders/violations/${id}`)
      .then(handleResponse)
      .catch(handleError),
  exportViolations: (params) =>
    api
      .get("/orders/violations/export", { params, responseType: "blob" })
      .then(handleResponse)
      .catch(handleError),
};
...
export const workersAPI = {
  ...
  workers: {
    ...
    create: (data) =>
      api.post("/workers", data).then(handleResponse).catch(handleError),
    update: (id, data) =>
      api.put(`/workers/${id}`, data).then(handleResponse).catch(handleError),
  },
  // Attendance tracking
  attendance: {
    list: () =>
      api.get("/workers/attendance").then(handleResponse).catch(handleError),
    record: (data) =>
      api
        .post("/workers/attendance", data)
        .then(handleResponse)
        .catch(handleError),
  },
  ...
  remuneration: {
    calculate: (workerId, params = {}) => {
      return api
        .get(`/workers/${workerId}/remuneration`, { params })
        .then(handleResponse)
        .catch(handleError);
    },
  },
  ...
  getSummary: (workerId, params = {}) => {
    return api
      .get(`/task-completions/worker/${workerId}/summary`, {
        params,
        timeout: 10000,
      })
      .then(handleResponse)
...
export const lunchAllowanceAPI = {
  getAll: (params = {}) => {
    return api
      .get("/lunch-allowances", { params })
      .then(handleResponse)
      .catch(handleError);
  },
  generate: (data) =>
    api
      .post("/lunch-allowances/generate", data)
      .then(handleResponse)
      .catch(handleError),
  update: (id, data) =>
    api
      .put(`/lunch-allowances/${id}`, data)
      .then(handleResponse)
      .catch(handleError),
  delete: (id) =>
    api
      .delete(`/lunch-allowances/${id}`)
      .then(handleResponse)
      .catch(handleError),
  getSummary: (params = {}) => {
    return api
      .get("/lunch-allowances/summary", { params })
      .then(handleResponse)
      .catch(handleError);
  },
};
...
export const transactionsAPI = {
  getLaborCosts: (params) =>
    api
      .get("/transactions/labor", { params })
      .then(handleResponse)
      .catch(handleError),
  getLunchAllowanceCosts: (params) =>
    api
      .get("/transactions/lunch-allowances", { params })
      .then(handleResponse)
      .catch(handleError),
  getPurchases: (dateRange) =>
    api
      .get("/transactions/purchases", { params: dateRange })
      .then(handleResponse)
      .catch(handleError),
  recordPurchase: (data) =>
    api
      .post("/transactions/purchases", data)
      .then(handleResponse)
      .catch(handleError),
  getRepairs: (dateRange) =>
    api
      .get("/transactions/repairs", { params: dateRange })
      .then(handleResponse)
      .catch(handleError),
  recordRepair: (data) =>
    api
      .post("/transactions/repairs", data)
      .then(handleResponse)
      .catch(handleError),
  updateRepair: (id, data) =>
    api
      .put(`/transactions/repairs/${id}`, data)
      .then(handleResponse)
      .catch(handleError),
  getTransactionSummary: (dateRange) =>
    api
      .get("/transactions/summary", { params: dateRange })
      .then(handleResponse)
      .catch(handleError),
};
...
export const taskRateAPI = {
  getAll: (params) =>
    api.get("/task-rates", { params }).then(handleResponse).catch(handleError),
  getById: (id) =>
    api.get(`/task-rates/${id}`).then(handleResponse).catch(handleError),
  create: (data) =>
    api.post("/task-rates", data).then(handleResponse).catch(handleError),
  update: (id, data) =>
    api.put(`/task-rates/${id}`, data).then(handleResponse).catch(handleError),
  delete: (id) =>
    api.delete(`/task-rates/${id}`).then(handleResponse).catch(handleError),
  getByType: (taskType) =>
    api
      .get(`/task-rates/by-type/${taskType}`)
      .then(handleResponse)
      .catch(handleError),
};
...
export const taskCompletionAPI = {
  getAll: (params) =>
    api
      .get("/task-completions", { params })
      .then(handleResponse)
      .catch(handleError),
  getById: (id) =>
    api.get(`/task-completions/${id}`).then(handleResponse).catch(handleError),
  record: (data) =>
    api.post("/task-completions", data).then(handleResponse).catch(handleError),
  update: (id, data) =>
    api
      .put(`/task-completions/${id}`, data)
      .then(handleResponse)
      .catch(handleError),
  verify: (id, data) =>
    api
      .put(`/task-completions/${id}/verify`, data)
      .then(handleResponse)
      .catch(handleError),
  getWorkerSummary: (workerId, params) =>
    api
      .get(`/task-completions/worker/${workerId}/summary`, { params })
      .then(handleResponse)
      .catch(handleError),
};
...
export const reportsAPI = {
  ...
  discountApprovals: (params = {}) =>
    api
      .get("/reports/discount-approvals", {
        params,
        headers: { "x-cache-max-age": "300000" }, // 5 minutes
      })
      .then(handleResponse)
  ...
  workerRemuneration: async (params = {}) => {
    try {
      ...
      if (
        typeof workerTasksAPI !== "undefined" &&
        workerTasksAPI.tasks &&
        workerTasksAPI.tasks.list
      ) {
      ...
      if (!Array.isArray(tasks)) {
        console.warn(
          "Tasks is not an array, returning empty remuneration data"
        );
        return [];
      }
